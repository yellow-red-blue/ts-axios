import { AxiosRequestConfig, AxiosPromise, AxiosResponse, ResolvedFn, RejectedFn, Method } from '../types/index'
...
export default class Axios {
  ...
  constructor(innitConfig: AxiosRequestConfig) {
    this.defaults = innitConfig
    this.interceptors = {
